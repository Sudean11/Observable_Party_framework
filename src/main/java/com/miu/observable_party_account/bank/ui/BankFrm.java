package com.miu.observable_party_account.bank.ui;

import com.miu.observable_party_account.bank.observer.EmailObserver;
import com.miu.observable_party_account.bank.observer.Observable;
import com.miu.observable_party_account.bank.reveiver.TransactionHistroyReceiver;
...
import com.miu.observable_party_account.bank.commands.AddInterestCommand;
import com.miu.observable_party_account.framework.command.Command;
import com.miu.observable_party_account.bank.commands.TransactionHistoryCommand;
import com.miu.observable_party_account.framework.command.GetAllAccountsCommand;
import com.miu.observable_party_account.framework.entity.Account;
import com.miu.observable_party_account.framework.receiver.AccountsResultReceiver;
...
public class BankFrm extends javax.swing.JFrame
{
	...
	{
		myframe = this;
		bankService = new StrategyBankService().getService();
...
//        rowdata = new Object[8];
		...
		JButton_TransactionHistory.setText("Transaction History");
		JPanel1.add(JButton_TransactionHistory);
		JButton_TransactionHistory.setBounds(468, 64, 150, 33);
...
private void setupConfiguration() {
	...
	javax.swing.JButton JButton_TransactionHistory = new javax.swing.JButton();
...
//			System.exit(0);            // close the application
	...
	class SymAction implements java.awt.event.ActionListener
	{
		public void actionPerformed(java.awt.event.ActionEvent event)
		{
			...
			else if (object == JButton_TransactionHistory)
				JButtonTransactionHistory_actionPerformed(event);
