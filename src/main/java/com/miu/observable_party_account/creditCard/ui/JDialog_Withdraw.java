...
import com.miu.observable_party_account.framework.command.WithdrawCommand;
...
public class JDialog_Withdraw extends javax.swing.JDialog
{
	...
	public JDialog_Withdraw(CardFrm parent, String aname, double currentAmount)
	{
		super(parent);
		parentframe=parent;
		name=aname;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		double newamount = currentAmount-Double.parseDouble(parentframe.amountDeposit);

		if (newamount <0){
		       JOptionPane.showMessageDialog(this, " "+name+" Your balance is negative: $"+String.valueOf(newamount)+" !","Warning: negative balance",JOptionPane.WARNING_MESSAGE);
		}else{
