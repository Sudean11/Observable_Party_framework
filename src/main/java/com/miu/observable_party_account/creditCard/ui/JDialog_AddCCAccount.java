...
import com.miu.observable_party_account.creditCard.commands.CreateCreditCardAccountCommand;
import com.miu.observable_party_account.creditCard.entities.Person;
...
public class JDialog_AddCCAccount extends javax.swing.JDialog
{
	...
	public JDialog_AddCCAccount(CardFrm parent, AccountService creditCardService)
	{
		super(parent);
		parentframe=parent;
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
       ...
       if (JRadioButton_Gold.isSelected())
           parentframe.accountType= AccountType.GOLD;
           else{
       ...
       dispose();
	   Person person = new Person(parentframe.ccnumber, parentframe.clientName, parentframe.street, parentframe.city, parentframe.state, parentframe.zip, JTextField_ExpDate.getText(), JTextField_Email.getText(), parentframe.accountType);
	   Command createAccountCommand = new CreateCreditCardAccountCommand(creditCardService, person);
