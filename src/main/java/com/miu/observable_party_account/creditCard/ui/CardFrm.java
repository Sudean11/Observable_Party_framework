package com.miu.observable_party_account.creditCard.ui;
...
import com.miu.observable_party_account.creditCard.commands.GenerateReportCommand;
import com.miu.observable_party_account.creditCard.receiver.ReportResultReceiver;
...
public class CardFrm extends javax.swing.JFrame
{
	...
	public CardFrm()
	{
		...
		reportReceiver = new ReportResultReceiver();
		 creditService = new StrategyCreditCardService().getService();
